...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"holong/feeds/cambien1", "holong/feeds/cambien2"
                                            ,"holong/feeds/nutnhan1","holong/feeds/nutnhan2"
                                        };

    final String clientId = "12345678";
    final String username = "holong";
    final String password = "aio_Ahvt472c11ui846b1nKbVJ62ZF3S";
